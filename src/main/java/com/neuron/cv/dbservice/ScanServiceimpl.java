...
public class ScanServiceimpl {
	...
	public InspectionReportResultDto generateCVReport(ParamDTO paramDTO) {
		...
		String markerFile = markerFileService.getInspectionReportSessionFile(paramDTO.getFolderPath(),
				paramDTO.getSessionId());
		String propCalcs = markerFileService.getPropCalc(paramDTO.getFolderPath(), markerFile);
		instaplanDto = metricsCalucatorService.getPropertyCalcProps(new JSONObject(propCalcs), instaplanDto);
